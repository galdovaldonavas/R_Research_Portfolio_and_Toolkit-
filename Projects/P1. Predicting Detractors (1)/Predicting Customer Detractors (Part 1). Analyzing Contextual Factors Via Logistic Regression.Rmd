...
## 4.1. Convergent Validity of NPS Scores
...
# 5. Explorations of Factor Interactions
...
## 5.1. Function to Generate Heatmaps
...
## 5.2. Heatmap for NPS in Categorical Scores
...
## 5.2. Heatmap for NPS Raw Scores
...
## 5.3. Heatmap for Satisfaction Scores
...
## 5.4. Convergence of Results Across Measures
...
# 6. Modeling NPS from Contextual Factors
...
## 6.2. Discarding Linear Modeling
...
## 6.3. Discarding Ordinal Modeling
...
#### 6.3.1. Checking the Collinearity Assumption
...
### 6.3.2. Checking the Proportional Odds Assumption
...
##### 6.3.2.1 Addressing Non-Proportional Odds by Incorporating an Interaction Term
...
##### 6.3.2.2 Addressing Non-Proportional Odds by Modeling Varying Coefficients
...
##### 6.3.2.3.  Identifying Sections in the NPS Scale with Common Non-Proportional Odds
...
## 6.3. Binomial Logistic Regression Modeling
...
#### 6.3.1. Creating Metrics to Interpret the Model
