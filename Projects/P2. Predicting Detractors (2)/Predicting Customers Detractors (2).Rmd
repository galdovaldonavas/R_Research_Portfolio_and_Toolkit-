...
# 5.3.2. Exploration with Descriptives and Visualizations of Specific Problems
...
We can see that problems loading photos are specially present in slow resolution complaints of incorrect item issues, while these type of problems rarely appear in other type of issues. 

It also looks like the difference across conditions in the presence of slow resolution complaints is proportional to the difference across conditions to in the mention of problems loading photos. We can see this better in a graph that superpose the proportions. 
...
- Reescribir: 
  ...
  - opcional: recodificar las variable a una sola de tal manera que pueda ver la contribución del problema de las photos, siguiendo el gráfico que haya he hecho aquí. 
