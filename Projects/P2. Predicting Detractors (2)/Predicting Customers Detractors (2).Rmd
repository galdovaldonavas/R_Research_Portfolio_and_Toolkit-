...
data.ch.i$sp.solve.complain.problem [data.ch.i$no.complain.sp.solve == 1] <- "No slow resolution complaint"
...
data.ch.i$sp.solve.complain.problem  <- factor (data.ch.i$sp.solve.complain.problem, levels = c("No slow resolution complaint","Chat not loading photos", "Other problems"))
...
complaints.problems.df$dv.level  <- factor (complaints.problems.df$dv.level, levels = c("No slow resolution complaint","Chat not loading photos", "Other problems"))
...
ggplot(complaints.problems.df, aes(x = factor, y = percentage, fill = dv.level)) +
  ...
  labs(x = "Condition",
       y = "% of Cases",
       fill = "Problem type",
       title = "Share of Photo Problems in Slow Resolution Complaints") +
  ...
  scale_fill_manual(values = c(
    "No slow resolution complaint" = "grey95",      
