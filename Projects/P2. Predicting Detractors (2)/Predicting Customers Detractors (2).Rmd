...
---
Title: Predicting Customer Detractors (Part 2): Discovering Opportunities From Open Feedback

# 1. Introduction

This case study explores opportunities the likelihood to recommend the company customer service from the comments of the customers.

It is a continuation of the project [Predicting Customer Detractors (Part 1). Analyzing Contextual Factors Via Logistic](https://rpubs.com/galdovaldonavas/1335090), which provided insights on the specific customer service contexts that customers had the lowest probability to recommend. 

In this phase we prioritized a follow up of those contexts, in which we conducted a thematic anaysis of the open comments left by customers in the NPS survey to identify specific issues that could be corrected. Also this project analyzes the potential impact of correcting these issues. .
...
- Descriptive statistics (percentages and confidence intervals)
- Logistic regression modeling
- Simulation-based predictions, using bootstrapping techniques
