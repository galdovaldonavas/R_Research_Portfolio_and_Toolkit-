...
library(MASS)        # Generation of random coefficients
...
We will simulate how the correction of each of the problems identified would impact the reduction of detractors using a Montercarlo technique.
...
For the deadlines problems there were not significant differences, so we will use the general prevalence of this problem in the whole sample. We first calculate it and imput its value for both conditions in the above results. 
