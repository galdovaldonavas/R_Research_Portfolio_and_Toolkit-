...
* Presence of complaints about slow resolution: 
  ...
  * Other issues: 
    * 5% of complaints about difficulties attaching the photo to the chat. 
...
# ---- Code for Problems Present in the Slow Resolution Complaints

## Problems attaching the photo in the chat

# Base probability in other issues: 10%
prob_photo <- rep(0.05, n.data.ch.i)
# For incorrect item issues, this probability is multiplied by 14
prob_photo[data.ch.i$condition == "chat_incorrect_item"] <- prob_photo[data.ch.i$condition == "chat_incorrect_item"] * 14
# Ensure probability values remain within [0, 1]
prob_photo [prob_photo > 1] <- 1
prob_photo [prob_photo < 0] <- 0
# Generate binary variable based on probabilities
