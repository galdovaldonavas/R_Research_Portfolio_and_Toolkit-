...
### 4.3.1. Discarding a Linear Regression Model. 
...
### 4.3.2. Evaluating the Appropriateness of an Ordinal Model
...
### 4.3.2.1. Checking the Collinearity Assumption
...
##### 4.3.2.2. Checking the Proportional Odds Assumption
...
###### 4.3.2.2.1 Addressing Non-Proportional Odds by Incorporating an Interaction Term
...
###### 4.3.2.2.2 Addressing Non-Proportional Odds by Modeling Varying Coefficients
...
###### 4.3.2.2.3.  Identifying Sections in the NPS Scale with Common Non-Proportional Odds
...
### 4.3.3. Binomial Logistic Regression Model to Predict Detractors
...
#### 4.3.3.1. Creating Metrics to Interpret the Model
...
However, we do not yet know the specific issues customers encounter within each contextual factor. This will be explored in the next section.
